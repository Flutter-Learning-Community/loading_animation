...
class loading_animation extends StatefulWidget {
  @override
  _loading_animationState createState() => _loading_animationState();
}

class _loading_animationState extends State<loading_animation> {
  @override
